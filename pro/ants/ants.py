...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 7
        return not(self.place.ant is None or (self.place.ant and self.place.ant.blocks_path == False))
        # END Problem 7
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        distance = 0
        while current_place and current_place is not hive:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        current_place = self.place
        bees_in_place = current_place.bees
        self.armor -= amount
        if self.armor <= 0:
            current_place.remove_insect(self)
            for bee in list(bees_in_place):
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        return (not ( self.contained_ant or other.is_container))
        # END Problem 9
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        # BEGIN Problem 13
        "*** YOUR CODE HERE ***"
        if QueenAnt.true_queen is not self:
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0 and self is QueenAnt.true_queen:
        	bees_win()
        # END Problem 13
